---
title: "final project"
author: "Yixin Zheng, Ada Gao, Khue Nguyen"
date: "`r Sys.Date()`"
output: pdf_document
header-includes:
...
Breast cancer prognosis is essential for guiding treatment and improving
patient survival. This study uses logistic regression to identify key
factors that influence whether patients survive or not (status: Alive or
Dead). The goal is to build a clear and understandable model to predict
survival and see how well it works across different racial groups. It
also focuses on fairness by examining performance differences between
groups and finding ways to improve generalizability of the model.
