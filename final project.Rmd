...
par(mfrow = c(1, 1))
```
All the procedures generated the same model.
...
describe your final model to  predict the risk of death.and interpret its parameters in an accurate and useful manner, explore several candidate models, and explain why you selected your model.
...
between the majority race group “White” and the minority “Black” (or “Black” + “Other”)? If
not, could you try to improve the fairness (i.e., reducing the gap of prediction performance
between the majority and minority) of your model(s)?


## Conclusion
1. Your report should include a table summarizing parameter estimates associated with your final fitted model, characterizing predictor variables in a way that a reader can clearly understand
2. conclusion and discussion (results intepretation)
